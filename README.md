...
5. Step: **Configure the machine type and Linux Version**
	...
	* **Select the Linux Kernel Version**
	 	* With following code line,it is possible to select the prefered Linux Kernel Version (here with Version 5.5)
			````bibtabe
...
[![GitHub stars](https://img.shields.io/github/stars/robseb/meta-altera?style=social)](https://GitHub.com/robseb/meta-altera/stargazers/)
[![GitHub watchers](https://img.shields.io/github/watchers/robseb/meta-altera?style=social)](https://github.com/robseb/meta-altera/watchers)
